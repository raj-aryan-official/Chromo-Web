...
const Header = () => {
  ...
  return (
    <header className={styles.header} style={isScrolled ? { boxShadow: '0 5px 20px rgba(0,0,0,0.3)' } : {}}>
      ...
      <div className={styles.bottomSection}>
        <div className={styles.quickLinks}>
          <Link to="/?category=new" className={styles.quickLink}><Tag size={16}/> New Colors</Link>
          <Link to="/palette-studio" className={styles.quickLink}><Paintbrush size={16}/> Palette Studio</Link>
          <Link to="/" className={styles.quickLink}><Package size={16}/> Shop Products</Link>
          <Link to="/calculator" className={styles.quickLink}>🧮 Paint Calculator</Link>
          <Link to="/expert" className={styles.quickLink}>👨‍🔧 Connect to Expert</Link>
          <Link to="/guide" className={styles.quickLink}>📚 Paint Guide</Link>
        </div>
      </div>
